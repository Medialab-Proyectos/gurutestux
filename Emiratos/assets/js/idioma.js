...
(function () {
  ...
  var EN = {
      ...
      "Editar el rol": "Edit role",
      "Un rol inactivo no se puede asignar a nuevos usuarios.": "An inactive role can’t be assigned to new users.",
      "El administrador siempre está activo: sin él, nadie podría administrar la empresa.": "The administrator is always active: without it, nobody could manage the company.",
      "Lista de permisos disponibles": "Available permissions",
      "El administrador siempre tiene todos los permisos: si se le pudiera quitar uno, una empresa podría dejarse fuera de su propio portal.": "The administrator always has every permission: if one could be removed, a company could lock itself out of its own portal.",
      "Ponle un nombre al rol.": "Give the role a name.",
      "Ya hay un rol con ese nombre.": "There is already a role with that name.",
      "creado. Asígnale permisos desde el candado de su fila.": "created. Assign its permissions from the lock in its row.",
      "Permisos del rol": "Role permissions",
      "Alta y baja de los usuarios de tu empresa.": "Add and remove your company’s users.",
      "Wiki de eDoc": "eDoc wiki",
      "Toda la documentación del producto, siempre al día. Es la fuente de lo que hay debajo.": "All the product documentation, always up to date. It is the source of what is below.",
      "En línea": "Online",
      "Buscar un permiso": "Search for a permission",
      "Solo los asignados": "Only the assigned ones",
      "Los que no tienes": "The ones you don’t have",
      "Asignado": "Assigned",
      "No lo tienes": "Not yours",
      "Ningún permiso coincide con lo que buscas.": "No permission matches your search.",
      "Compañía": "Company",
      "El registro fiscal de la empresa con la que entras.": "The tax registration of the company you sign in with.",
      "Escribe el registro fiscal de tu empresa.": "Enter your company’s tax registration.",
      "Usuarios con el rol": "Users with this role",
      "Qué nos llega en la vuelta, y qué no vale.": "What arrives on the return, and what isn’t good enough.",
      "En Emiratos es la autoridad fiscal quien autoriza a un proveedor a facturar por tu empresa. Mientras eso no conste no podemos darte de alta, así que tampoco te pedimos tus datos todavía: este paso va antes que los seis del formulario.": "In the UAE it is the tax authority that authorises a provider to invoice for your company. Until that is on record we can’t register you, so we don’t ask for your details yet: this step comes before the six in the form.",
      "El aviso de arriba desaparece y en": "The notice above disappears and in",
      "aparece la conexión con la autoridad como": "the connection with the authority appears as",
      ", con la fecha.": ", with the date.",
      "Te registramos en la red con tu identificador": "We register you on the network with your identifier",
      ". Es la dirección a la que te llegarán las facturas de tus proveedores: si la ves, estás dentro.": ". It is the address where your suppliers’ invoices will arrive: if you can see it, you are in.",
      "En el panel de la autoridad, tu proveedor nombrado aparece como": "In the authority’s dashboard, your appointed provider appears as",
      ". Si dice pendiente o fallido, la asociación no llegó a hacerse.": ". If it says pending or failed, the association never completed.",
      ". Se enseña para que sepas por qué ves unas opciones y no otras.": ". It is shown so you know why you see some options and not others.",
      "Cada vez que entras te mandamos un código de seis cifras a": "Every time you sign in we send a six-digit code to",
      ". Sin ese código no hay sesión.": ". Without that code there is no session.",
      "En la maqueta vale cualquier código de seis cifras. Con": "In the mockup any six-digit code works. With",
      "se ve qué pasa cuando el código no es correcto.": "you can see what happens when the code is wrong.",
      "Cómo sabrás que ya estás habilitado": "How you will know you are live",
      "No tienes que avisarnos ni escribir ningún código. Al volver lo verás en tres sitios, y los tres dicen lo mismo:": "You don’t have to tell us or type any code. When you come back you will see it in three places, and all three say the same:",
      "Aquí, en tu cuenta": "Here, in your account",
      "Tu dirección en la red": "Your address on the network",
      "Es la dirección a la que te llegarán las facturas de tus proveedores: si la ves, estás dentro.": "It is the address where your suppliers’ invoices will arrive: if you can see it, you are in.",
      "En EmaraTax": "In EmaraTax",
      "Si dice pendiente o fallido, la asociación no llegó a hacerse.": "If it says pending or failed, the association never completed.",
      "Conexión con la autoridad": "Connection with the authority",
      "Proveedor nombrado en EmaraTax": "Provider appointed in EmaraTax",
      "Solo puede haber uno, y cubre lo que emites y lo que recibes.": "There can only be one, and it covers what you issue and what you receive.",
      "Aquí te llegan las facturas de tus proveedores.": "This is where your suppliers’ invoices arrive.",
      "Asociación confirmada": "Association confirmed",
      "Desde esa fecha podemos emitir y recibir a tu nombre.": "From that date we can issue and receive on your behalf.",
      "Paso 0": "Step 0",
      "Antes de empezar": "Before you start",
      "Registro de empresa · Paso 0": "Company registration · Step 0",
      "En el portal de la autoridad, antes de tus datos": "In the authority’s portal, before your details",
      "En Emiratos es la autoridad fiscal quien autoriza a un proveedor a facturar por tu empresa. Mientras eso no conste, no podemos dar de alta tu empresa aquí, así que tampoco te pedimos tus datos todavía: este paso va antes que los seis del formulario.": "In the UAE it is the tax authority that authorises a provider to invoice for your company. Until that is on record we can’t register your company here, so we don’t ask for your details yet: this step comes before the six in the form.",
      "El alta empieza en EmaraTax": "Registration starts in EmaraTax",
      "Primero tienes que elegirnos en EmaraTax": "First you have to choose us in EmaraTax",
      "En Emiratos es la autoridad fiscal quien autoriza a un proveedor a facturar por tu empresa. Mientras eso no conste, no podemos dar de alta tu empresa aquí, así que tampoco te pedimos tus datos todavía.": "In the UAE it is the tax authority that authorises a provider to invoice for your company. Until that is on record we can’t register your company here, so we don’t ask for your details yet.",
      "Búscanos y selecciónanos": "Find us and select us",
      "EmaraTax te avisa de que vas a salir de su sistema y te trae aquí. Entonces sí te pedimos tus datos, y algunos ya vendrán puestos.": "EmaraTax warns you that you are leaving their system and brings you here. Then we do ask for your details, and some will already be filled in.",
      "Ya tengo un código de seguimiento": "I already have a tracking code",
      "Desde aquí no se sale de verdad al portal de impuestos.": "This doesn’t really leave for the tax portal.",
      "El alta empieza en EmaraTax, donde nos eliges como tu proveedor; aquí completas tus datos. Verificamos tu correo corporativo y después son seis pasos.": "Registration starts in EmaraTax, where you choose us as your provider; here you complete your details. We verify your corporate email and then there are six steps.",
      "En el portal de la autoridad. Es lo que nos autoriza a facturar por ti.": "In the authority’s portal. It is what authorises us to invoice on your behalf.",
      "Antes": "First",
      "¿Ya nos elegiste en EmaraTax?": "Have you already chosen us in EmaraTax?",
      "Es lo que autoriza a la autoridad a que facturemos por ti, y por eso va antes que este formulario. Puedes rellenarlo igualmente: la solicitud queda guardada con su código y esperando esa asociación.": "It is what tells the authority we may invoice on your behalf, and that is why it comes before this form. You can fill it in anyway: the application is saved with its code and waits for that association.",
      "Cómo se hace": "How it’s done",
      "Si todavía no lo has hecho, es lo primero: hasta que la autoridad nos diga que nos has elegido, tu solicitud se queda esperando.": "If you haven’t done it yet, it comes first: until the authority tells us you chose us, your application waits.",
      "Emitir y recibir": "Issue and receive",
      "Con la asociación confirmada y tus credenciales, el portal queda activo para tu empresa.": "With the association confirmed and your credentials, the portal is live for your company.",
      "Empieza eligiéndonos en EmaraTax, que es lo que nos autoriza; dentro te explicamos cómo y completas tus datos.": "It starts by choosing us in EmaraTax, which is what authorises us; inside we explain how and you complete your details.",
      "Es lo que nos autoriza a facturar por ti, y se hace en el portal de la autoridad, no en el nuestro. Sin esta asociación no podemos emitir ni recibir documentos a tu nombre.": "It is what authorises us to invoice on your behalf, and it happens in the authority’s portal, not ours. Without this association we can’t issue or receive documents in your name.",
      "En Emiratos el alta empieza aquí: en EmaraTax nos eliges como tu proveedor y ese sistema te trae de vuelta a nosotros. Lo demás —tus datos y la revisión— va después, y no tienes que avisarnos de nada: la autoridad nos confirma la asociación.": "In the UAE registration starts here: in EmaraTax you choose us as your provider and that system brings you back to us. The rest — your details and the review — comes after, and you don’t have to tell us anything: the authority confirms the association.",
      "Verificamos tu correo corporativo y después son seis pasos. El servicio se activa al final, cuando nos eliges en EmaraTax.": "We verify your corporate email and then there are six steps. The service switches on at the end, when you choose us in EmaraTax.",
      "Vienes de EmaraTax y ya nos has elegido como proveedor.": "You are coming from EmaraTax and you have already chosen us as your provider.",
      "Los datos que nos manda la autoridad vienen puestos y no hace falta que los escribas. Completa lo que falte y listo: esta solicitud ya no espera nada más de ti en el portal de impuestos.": "The details the authority sends us are already filled in, so you don’t have to type them. Complete what’s missing and that’s it: this application needs nothing else from you in the tax portal.",
      "Activación en EmaraTax": "Activation in EmaraTax",
      "Fuera del formulario: se hace en el portal de la autoridad.": "Outside this form: it happens in the authority’s portal.",
      "Hecho: llegaste desde el portal de la autoridad.": "Done: you arrived from the authority’s portal.",
      "Al terminar": "At the end",
      "Después": "Later",
      "Asociado en EmaraTax": "Associated in EmaraTax",
      "Hecho: llegaste desde el portal de la autoridad, así que la asociación ya nos consta.": "Done: you arrived from the authority’s portal, so the association is already on record.",
      "¿Y si no llega?": "And if it doesn’t arrive?",
      "La confirmación suele tardar minutos. Si al día siguiente sigues viendo este aviso, lo normal es una de estas tres: que en EmaraTax quedara otro proveedor elegido, que el registro fiscal con el que entraste allí no sea el mismo de esta cuenta, o que se cerrara la ventana antes de volver. Vuelve a intentarlo y, si sigue igual, escríbenos con tu TRN desde el acceso al soporte.": "Confirmation usually takes minutes. If you still see this notice the next day, it is normally one of three things: another provider was left selected in EmaraTax, the tax registration you signed in with there is not the one on this account, or the window was closed before coming back. Try again and, if it stays the same, write to us with your TRN from the support link.",
      "Seis pasos, y dentro te decimos cómo elegirnos en EmaraTax, que es lo que activa el servicio.": "Six steps, and inside we tell you how to choose us in EmaraTax, which is what switches the service on.",
      "El alta termina en EmaraTax.": "The registration ends in EmaraTax.",
      "Con este formulario nos das tus datos y los revisamos. Después, en el portal de la autoridad, tienes que elegirnos como tu proveedor: hasta entonces no podemos emitir ni recibir documentos a tu nombre. Te explicamos cómo al terminar.": "With this form you give us your details and we review them. Then, in the authority’s portal, you must choose us as your provider: until then we can’t issue or receive documents on your behalf. We explain how at the end.",
      "Asociarnos en EmaraTax →": "Associate us in EmaraTax →",
      "Ir al login": "Go to sign-in",
      "Volver al registro": "Back to the registration",
      "Marca la casilla para entrar.": "Tick the box to go in.",
      "Dar de alta tu empresa son dos pasos, en este orden.": "Registering your company takes two steps, in this order.",
      "Registrar mi empresa aquí": "Register my company here",
      "Seis pasos. Revisamos los datos y te mandamos tus credenciales por correo.": "Six steps. We review the details and email you your credentials.",
      "Elegirnos en EmaraTax": "Choose us in EmaraTax",
      "En el portal de la autoridad nos eliges como tu proveedor. Desde ahí te traen de vuelta y el portal se desbloquea.": "In the authority’s portal you choose us as your provider. From there you are brought back and the portal unlocks.",
      "Revisamos tu solicitud": "We review your application",
      "Si falta algo te escribimos al correo del administrador. Con el código de arriba puedes retomar el expediente.": "If something is missing we email the administrator. With the code above you can pick the application back up.",
      "Te mandamos tus credenciales": "We send you your credentials",
      "Al aprobarla. La primera vez que entres tendrás que cambiar la contraseña.": "Once it is approved. The first time you sign in you will have to change the password.",
      "Nos eliges en EmaraTax": "You choose us in EmaraTax",
      "Es el último paso, y se hace en el portal de la autoridad: hasta que la asociación llegue no podemos emitir ni recibir a tu nombre.": "It is the last step, and it happens in the authority’s portal: until the association arrives we can’t issue or receive on your behalf.",
      "Cómo nos eliges en EmaraTax": "How you choose us in EmaraTax",
      "Paso 2 de 2 del alta. El registro ya está hecho; falta que la autoridad sepa que nos has elegido, y eso se hace en su portal, no en el nuestro.": "Step 2 of 2 of the registration. The registration is done; now the authority has to know you chose us, and that happens in their portal, not ours.",
      "Dónde estás.": "Where you are.",
      "Primero registraste tu empresa con nosotros y te dimos tus credenciales. Esto es lo que falta: entrar a EmaraTax, elegirnos como proveedor y volver. No hay un tercer paso ni tienes que avisarnos: la autoridad nos confirma la asociación.": "First you registered your company with us and we gave you your credentials. This is what’s left: sign in to EmaraTax, choose us as your provider and come back. There is no third step and you don’t have to tell us: the authority confirms the association.",
      "Al continuar, aceptas los": "By continuing, you accept the",
      "y el": "and the",
      "de eDoc.": "from eDoc.",
      "Desactivar el acceso": "Turn off access",
      "Devolver el acceso": "Restore access",
      "Vas a dejar fuera del portal a": "You are about to lock out of the portal",
      "Vas a devolver el acceso a": "You are about to restore access for",
      "No se borra nada: el usuario y sus documentos se quedan, pero deja de poder entrar. Puedes devolverle el acceso cuando quieras.": "Nothing is deleted: the user and their documents stay, but they can no longer sign in. You can restore access whenever you want.",
      "Volverá a entrar con su usuario de siempre. Si no recuerda la contraseña, puede recuperarla desde el acceso.": "They will sign in with their usual user. If they don’t remember the password, they can recover it from the sign-in screen.",
      "Queda registrado quién lo hizo y cuándo.": "Who did it and when is recorded.",
      "Empresa": "Company",
      ". Aquí se ven para que sepas con qué identidad estás entrando y a qué correo te llegan los códigos.": ". They are shown here so you know which identity you are signing in with and where the codes go.",
      "Mi cuenta": "My account",
      "Usuarios eDoc": "eDoc users",
      "Tus datos, tu contraseña y el rol con el que entras. Los datos de la empresa y los demás usuarios se administran en Administración.": "Your details, your password and the role you sign in with. Company details and other users are managed in Administration.",
      "Cuenta": "Account",
      "Seguridad": "Security",
      "Datos personales": "Personal details",
      "Aquí llegan el código de acceso y los avisos de tu cuenta.": "This is where your sign-in code and account notices arrive.",
      "Estos datos los cambia un administrador de tu empresa desde": "These details are changed by an administrator of your company in",
      "Aquí se ven para que sepas con qué identidad estás entrando y a qué correo te llegan los códigos.": "They are shown here so you know which identity you are signing in with and where the codes go.",
      "Foto de perfil": "Profile photo",
      "Cambiar la foto": "Change the photo",
      "Formatos JPG o PNG · máximo 800 KB.": "JPG or PNG · 800 KB maximum.",
      "Foto de perfil de Fatima Al Marzooqi": "Profile photo of Fatima Al Marzooqi",
      "En la maqueta no se sube la foto: se abriría el explorador de archivos.": "The photo isn’t uploaded in the mockup: this would open the file browser.",
      "La cambiaste por última vez el": "You last changed it on",
      "Al cambiarla se cierran las sesiones abiertas en otros navegadores.": "Changing it signs out the sessions open in other browsers.",
      "Cambiar contraseña": "Change password",
      "Activada": "On",
      "Sin ese código no hay sesión.": "Without that code there is no session.",
      "No se puede desactivar.": "It can’t be turned off.",
      "La Decisión Ministerial 64/2025 obliga a la verificación en dos pasos para entrar al portal, así que el interruptor no existe: enseñar uno apagado sería prometer algo que no se puede hacer.": "Ministerial Decision 64/2025 requires two-step verification to enter the portal, so there is no switch: showing one turned off would promise something that can’t be done.",
      "Tu rol": "Your role",
      "Con este rol puedes administrar la empresa entera: sus usuarios, sus roles, sus datos fiscales y sus credenciales de conexión.": "With this role you can manage the whole company: its users, its roles, its tax details and its connection credentials.",
      "Qué te deja hacer": "What it lets you do",
      "Tu rol no se cambia desde aquí: lo asigna otro administrador desde": "Your role isn’t changed here: another administrator assigns it in",
      "Se enseña para que sepas por qué ves unas opciones y no otras.": "It is shown so you know why you see some options and not others.",
      "Ver y responder los documentos recibidos": "View and respond to received documents",
      "Consultar los documentos emitidos y sus estados": "Check issued documents and their statuses",
      "Administrar usuarios y roles de la empresa": "Manage the company’s users and roles",
      "Actualizar la identificación fiscal y los contactos": "Update the tax identification and the contacts",
      "Crear y retirar credenciales de conexión": "Create and retire connection credentials",
      "He leído y acepto el": "I have read and accept the",
      "y los": "and the",
      "Acepta los textos legales para entrar.": "Accept the legal texts to go in.",
      "Lee y acepta los dos documentos. El portal trata datos de tu empresa y de las personas que lo usan, así que sin aceptarlos no se puede entrar.": "Read and accept both documents. The portal handles data about your company and the people who use it, so you can’t go in without accepting them.",
      "He leído el": "I have read the",
      "He leído y acepto los": "I have read and accept the",
      "Acepta los dos documentos para entrar.": "Accept both documents to go in.",
      "Versión pendiente de publicar · se guarda la que aceptas, con la fecha.": "Version pending publication · we store the one you accept, with the date.",
      "Aceptar y entrar": "Accept and go in",
      "Salir sin entrar": "Leave without going in",
      "No se puede entrar sin aceptar los documentos.": "You can’t go in without accepting the documents.",
      "El código caducó. Vuelve a entrar para pedir uno nuevo.": "The code expired. Sign in again to request a new one.",
      "Pediste el código demasiadas veces. Vuelve a entrar para empezar de nuevo.": "You requested the code too many times. Sign in again to start over.",
      "Demasiados intentos con el código. Vuelve a entrar para pedir uno nuevo.": "Too many attempts with the code. Sign in again to request a new one.",
      "Cambio de contraseña": "Password change",
      "Cambia tu contraseña para entrar": "Change your password to go in",
      "Es tu primer ingreso. Antes de ver el portal tienes que poner una contraseña tuya: la que te enviamos la conoce quien te dio de alta.": "This is your first sign-in. Before you see the portal you must set a password of your own: the one we sent is known by whoever created your account.",
      "La que vas a usar de ahora en adelante": "The one you will use from now on",
      "La misma otra vez": "The same one again",
      "Esa contraseña no cumple: diez caracteres, una mayúscula, un número y un símbolo.": "That password doesn’t meet the rules: ten characters, an uppercase letter, a number and a symbol.",
      "Las dos contraseñas no coinciden.": "The two passwords don’t match.",
      "No hay forma de dejarlo para luego: sin cambiarla no se entra al portal.": "There is no way to postpone it: without changing it you can’t enter the portal.",
      "La contraseña que te enviamos por correo sirve para entrar una vez. La que elijas ahora es la tuya, y solo tú la conoces.": "The password we emailed you works once. The one you choose now is yours, and only you know it.",
      "Paso 1 · Usuario y empresa": "Step 1 · User and company",
      "Los mismos datos con los que entras al portal.": "The same details you sign in with.",
      "El mismo usuario con el que entras. No pedimos el correo: es el dato que mandaría el código a donde quisiera quien lo escribe.": "The same user you sign in with. We don’t ask for the email: that is the field that would send the code wherever the writer wanted.",
      "Un mismo usuario puede estar en varias empresas, con una contraseña en cada una. Sin saber cuál, no sabemos qué contraseña recuperar.": "The same user can exist in several companies, with a password in each. Without knowing which, we don’t know which password to recover.",
      "Dinos tu usuario.": "Tell us your user.",
      "Dinos con qué empresa entras.": "Tell us which company you sign in with.",
      "El código caducó. Vuelve a pedirlo desde el principio.": "The code expired. Request it again from the start.",
      "Pediste el código demasiadas veces. Empieza otra vez.": "You requested the code too many times. Start again.",
      "Demasiados intentos con el código. Empieza otra vez.": "Too many attempts with the code. Start again.",
      "Con una sola empresa no hay nada que preguntar": "With a single company there is nothing to ask",
      ...
      "empresas.": "companies.",
      "empresa.": "company.",
      "La fecha «desde» no puede ser posterior a «hasta».": "The “from” date can’t be later than the “to” date.",
      "Limpiar filtros": "Clear filters",
      "Todavía no hay nada aquí": "Nothing here yet",
      "Cuando haya registros, aparecerán en esta lista.": "When there are records, they will appear in this list.",
      "Ningún resultado con esos filtros": "No results with those filters",
      "Prueba con otras fechas o quita algún filtro.": "Try other dates or remove a filter.",
      "No hay documentos emitidos en ese rango de fechas": "There are no issued documents in that date range",
      "Prueba a ampliar las fechas. Los documentos aparecen aquí en cuanto tu sistema los envía.": "Try widening the dates. Documents appear here as soon as your system sends them.",
      "Ningún documento coincide con lo que buscas": "No document matches your search",
      "Revisa el número o quita algún filtro.": "Check the number or remove a filter.",
      "No has recibido documentos en ese rango de fechas": "You haven’t received any documents in that date range",
      "Prueba a ampliar las fechas. Lo que te envíen tus proveedores aparece aquí.": "Try widening the dates. What your suppliers send you appears here.",
      "No has pedido ningún reporte en ese rango de fechas": "You haven’t requested any report in that date range",
      "Pídelo desde Documentos Emitidos o Recibidos, con «Exportar».": "Request one from Issued or Received documents, with “Export”.",
      "Ninguna empresa coincide con lo que buscas": "No company matches your search",
      "Prueba con parte del nombre, en cualquier alfabeto, o quita algún filtro.": "Try part of the name, in any script, or remove a filter.",
      "No hay ningún expediente con ese código. Revisa que esté completo.": "There is no application with that code. Check that it is complete.",
      "Observación del revisor.": "Reviewer’s note.",
      "La licencia comercial del expediente caducó. Sube la vigente y pon su fecha de validez.": "The trade licence on file has expired. Upload the current one and enter its expiry date.",
      "El correo del contacto de cobros rebotó: no le llega a nadie. Pon uno que funcione.": "The billing contact’s email bounced: it reaches no one. Enter one that works.",
      "Ya está en el expediente. Haz clic para cambiarla.": "Already on file. Click to replace it.",
      "La que tenías caducó: sube la vigente.": "The one on file has expired: upload the current one.",
      "Con observaciones": "Needs changes",
      "Expediente": "Application",
      "recuperado. Te llevamos a lo que observó el revisor.": "recovered. We took you to what the reviewer flagged.",
      "La licencia está caducada. Sube la vigente y pon su nueva fecha.": "The licence has expired. Upload the current one and enter its new date.",
