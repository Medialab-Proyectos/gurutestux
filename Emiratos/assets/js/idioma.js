...
(function () {
  ...
  var EN = {
      ...
      "No se perdió nada: tu registro está guardado con el código de seguimiento": "Nothing was lost: your registration is saved under the tracking code",
      "¿Salir del registro?": "Leave the registration?",
      "Salir del registro": "Leave registration",
      "Seguir con el registro": "Stay in the registration",
      "Tu avance queda guardado. Puedes retomarlo cuando quieras con tu código de seguimiento:": "Your progress is saved. You can pick it up whenever you like with your tracking code:",
      "Todavía no has verificado tu correo, así que lo que has escrito no se guarda.": "You haven’t verified your email yet, so what you’ve typed isn’t saved.",
      "Copiar": "Copy",
      "Guárdalo: con él retomas el registro si cierras el navegador.": "Keep it: it lets you pick up the registration if you close the browser.",
      "Correo verificado": "Email verified",
      "Correo verificado.": "Email verified.",
      "Código de seguimiento copiado.": "Tracking code copied.",
      "No se pudo copiar solo: selecciónalo y cópialo a mano.": "It couldn’t be copied automatically: select it and copy it by hand.",
      "Retomamos tu registro donde lo dejaste.": "We picked up your registration where you left it.",
      "Seguimos donde lo dejaste.": "Picking up where you left off.",
      "Tu solicitud": "Your application",
      "Sin empezar": "Not started",
      "En curso": "In progress",
      "Te lo damos al verificar tu correo": "You get it when you verify your email",
      "El código son seis cifras.": "The code is six digits.",
      "Correo comercial": "Sales email",
      "Correo de cobros": "Collections email",
      "Los 36 caracteres del código": "The code’s 36 characters",
      "Tu correo de la empresa": "Your company email",
      "Tu cargo en la empresa": "Your job title",
      "Número, sin el prefijo": "Number, without the prefix",
      "Como figura en la licencia comercial": "As shown on the trade licence",
      "15 dígitos": "15 digits",
      "Calle, edificio y ciudad": "Street, building and city",
      "Como figura en la licencia": "As shown on the licence",
      "Con el prefijo del país": "With the country code",
      "Correo del contacto": "Contact’s email",
