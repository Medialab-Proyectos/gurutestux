...
(function () {
  ...
  var EN = {
      ...
      "Consulta tus documentos emitidos, responde los recibidos y administra tu conexión. Somos tu proveedor de servicios acreditado ante la Federal Tax Authority.": "Review the documents you issue, respond to the ones you receive and manage your connection. We are your accredited service provider before the Federal Tax Authority.",
      ...
      "Nosotros somos uno de esos proveedores: un": "We are one of those providers: an",
      ...
      "Nos buscas entre los proveedores acreditados y pulsas": "You find us among the accredited providers and click",
      ...
      "Consulta lo que emitiste, responde lo que recibes y administra tu conexión con nosotros. Somos tu proveedor de servicios acreditado ante la Federal Tax Authority.": "Review what you issued, respond to what you receive and manage your connection with us. We are your accredited service provider before the Federal Tax Authority.",
      "Proveedor de servicios acreditado · ASP": "Accredited service provider · ASP",
      "Red PEPOL": "PEPOL network",
      "Acciones": "Actions",
      "Cancelar": "Cancel",
      "Anterior": "Previous",
      "Siguiente": "Next",
      ...
      "No se puede desactivar: la autoridad de Emiratos exige que el acceso lleve un segundo factor.": "It cannot be turned off: the Emirates authority requires sign-in to include a second factor.",
      ...
      "Búscanos entre los proveedores acreditados": "Find us among the accredited providers",
      "en la lista de proveedores de servicios acreditados.": "in the list of accredited service providers.",
      ...
      "Tu proveedor de servicios acreditado · ASP": "Your accredited service provider · ASP",
      ...
      "Tu proveedor de servicios acreditado. Es quien transmite el documento por la red.": "Your accredited service provider. It transmits the document over the network.",
      "Aprueba el documento o lo rechaza si el XML no valida.": "Approves the document, or rejects it if the XML does not validate.",
      "El proveedor acreditado del comprador.": "The buyer’s accredited provider.",
      ...
      "Las reglas del servicio: qué presta eDoc como proveedor acreditado, qué se espera del cliente y qué pasa si una de las dos partes deja de cumplir.": "The rules of the service: what eDoc provides as an accredited provider, what is expected of the client and what happens if either party fails to comply.",
