...
window.EDOC_ALCANCE = (function () {
  ...
  var VISTAS = [
    ...
    { archivo: 'mi-perfil.html',           rotulo: 'Mi perfil',                                  grupo: 'Mi cuenta',          entrega: true  },
    { archivo: 'admin-clave.html',         rotulo: 'Cambiar Contraseña · ahora dentro de Mi perfil', grupo: 'Mi cuenta',       entrega: false },
    ...
    { archivo: 'admin-alertas.html',       rotulo: 'Alertas y comunicados · fase 2',             grupo: 'Administración',     entrega: false },
