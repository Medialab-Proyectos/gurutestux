...
window.EDOC_ALCANCE = (function () {
  ...
  var VISTAS = [
    ...
    { archivo: 'admin-empresa.html',       rotulo: 'Actualización datos de empresa',          grupo: 'Administración', entrega: false },
    { archivo: 'admin-contactos.html',     rotulo: 'Actualización información de empresa',    grupo: 'Administración', entrega: false },
